...
// 5 Russian
// 6 Norwegian
// 7 German for future version 1.0
#define LCDLanguage 2

// Arduino Logo at Startup
// true    display first Arduino logo then Pivovarduino logo
// false   starts only with Pivovarduino logo
...
/*
  ...
  Modified by Mirko Caiani:

  - Project PCB file for Arduino/Genuino 101 board
  - Some Variable initialization for avoid warnings
  - New Startup Logo
  - Deleted 16x2 Lenguage File and dipendences
  - Language file updated with new name e version - Only ita tested
  - In language file converted char* to const char to avoid warnings message - Only ita tested
