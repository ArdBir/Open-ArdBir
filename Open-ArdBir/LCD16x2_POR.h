...
char *unitName[]  ={"Escala     ", "Sensor     ", "Ebulicao   ", "Ciclo Bomba", "Pausa Bomba", "Bmb PreMash", "Bmb em Mash", "Bmb MashOut", "Bomb em Ebu", "Bomb Parada", "PID Pipe  " , "Skip Add      ", "Skip Remove ", "Skip Iodine ", "TempoIodo "};
